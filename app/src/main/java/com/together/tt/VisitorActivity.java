    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(MenuItem menuItem) {
                ...
                if(id == R.id.home){
                    Intent intent = new Intent(VisitorActivity.this, VisitorActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                    finish();
                }
                else if(id == R.id.chatting){
                    Intent intent = new Intent(VisitorActivity.this, ChattingActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                    finish();
                }
                else if(id == R.id.matefind){
                    Intent intent = new Intent(VisitorActivity.this, MatefindActivity.class);
                    startActivity(intent);
                    overridePendingTransition(0, 0);
                    finish();
                }
